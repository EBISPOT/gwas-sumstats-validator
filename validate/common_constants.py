...
DSET_TYPES = {SNP_DSET: str, RSID_DSET: str, MUTATION_DSET: str, AC_DSET: int, AN_DSET: int, PVAL_DSET: str, MANTISSA_DSET: float, EXPR_DSET: int, STUDY_DSET: str,
              CHR_DSET: int, BP_DSET: int, R2_DSET: float, BETA_DSET: float, SE_DSET: float, PHEN_DSET: str, GENE_DSET: str, MTO_DSET: str, MUTATION_DSET: str,
